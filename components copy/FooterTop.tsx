...
const FooterTop = () => {
  return (
    ...
    {data?.map((item, index) => (
       <div key={index} className='flex items-center gap-3 group hover:bg-gray-50 p-4 transition-colors hoverEffect'>{item?.icon}
        <div >
